= Antora UI BeagleBoard
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/beagleboard/antora-ui-beagle
:url-preview: https://beagleboard.github.io/antora-ui-beagle/
// External URLs:
...
This is the BeagleBoard.org theme for {url-antora}[Antora], forked from the default Antora UI.
This UI bundle is customized for BeagleBoard documentation sites.
You can see a live preview of this UI at {url-preview}.
...
== Use the BeagleBoard UI

If you want to use the BeagleBoard UI for your Antora-generated site, add the following UI configuration to your playbook:
...
Read on to learn how to customize this UI for your own documentation needs.

== Development Quickstart

This section offers a basic tutorial to teach you how to set up the BeagleBoard UI project, preview it locally, and bundle it for use with Antora.
A more comprehensive tutorial can be found in the documentation at {url-antora-docs}.

=== Prerequisites

To preview and bundle the BeagleBoard UI, you need the following software on your computer:
...
Clone the BeagleBoard UI project using git:

[subs=attributes+]
 $ git clone {url-project} &amp;&amp;
   cd "`basename $_`"

The example above clones the BeagleBoard UI project and then switches to the project folder on your filesystem.
...
The BeagleBoard UI project is configured to preview offline.
